...
function Project(){
    ...
    return(
     ...
     <button onClick={tsBtn} className={`w-44 h-14 rounded-lg text-center text-white bg-zinc-800 hover:transition-transform hover:scale-110  ${tsopen ? 'bg-purple-700' : 'bg-zinc-800 '}`}>TypeScript</button>
     <button onClick={frontendBtn} className={`w-44 h-14 rounded-lg text-center text-white bg-zinc-800 hover:transition-transform hover:scale-110 ${frontendOpen ? 'bg-zinc-800' : 'bg-purple-700 '} `}>Front-End</button>
     </section> 
