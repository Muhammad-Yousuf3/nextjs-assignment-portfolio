...
function Project(){
    ...
    return(
        <main className="h-full bg-black mt-40 mb-36">
             {/* Project Header */}
      <h1 className="text-white font-bold text-4xl md:mx-10 text-center md:text-left">My Projects</h1>

     <section className="mt-5 ml-10 flex gap-5">
     <button onClick={tsBtn} className={`w-44 h-14 rounded-lg text-center text-gray-500 bg-zinc-800 hover:transition-transform hover:scale-110  ${tsopen ? 'bg-zinc-800' : 'bg-purple-700 text-white'}`}>TypeScript</button>
     <button onClick={frontendBtn} className={`w-44 h-14 rounded-lg text-center text-gray-500 bg-zinc-800 hover:transition-transform hover:scale-110 ${frontendOpen ? 'bg-zinc-800' : 'bg-purple-700 text-white'} `}>Front-End</button>
     </section> 
      
      <section className=" bg-black">

        {/* TypeScript Projects */}
        <section className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-y-10 ml-10 mt-12 mb-10 ${tsopen ? 'hidden' : 'block'}`}>
...
<Image src={"/atm.jpg"} alt={"atm"} width={220} height={0} className="w-full opacity-35 h-[50%] rounded hover:transition-transform hover:scale-110"></Image>
...
<Image src={"/num guessing.webp"} alt={"number"} width={220} height={0} className="w-full opacity-35 h-[50%] rounded hover:transition-transform hover:scale-110"></Image>
...
<Image src={"/currency convertor.png"} alt={"number"} width={220} height={0} className="w-full opacity-35 h-[50%] rounded hover:transition-transform hover:scale-110"></Image>
...
<Image src={"/calculator.jpg"} alt={"calculator"} width={220} height={0} className="w-full opacity-35 h-[50%] rounded hover:transition-transform hover:scale-110"></Image>
...
<p className="text-gray-500 hover:text-purple-500 font-bold pl-2 py-3">Github</p>
      ...
      <section className="bg-zinc-900 w-72 h-96 rounded-lg mb-5 text-white text-justify">
         ...
         <Image src={"/transportweb.png"} alt={"transport web"} width={220} height={0} className="w-full opacity-35 h-[50%] rounded hover:transition-transform hover:scale-110"></Image>
      ...
      <section className="bg-zinc-900 w-72 h-96 rounded-lg mb-5 text-white text-justify">
         ...
         <Image src={"/resume.png"} alt={"resume"} width={220} height={0} className="w-full opacity-35 h-[50%] rounded hover:transition-transform hover:scale-110"></Image>
